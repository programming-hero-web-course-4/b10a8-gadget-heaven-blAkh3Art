...
const Page404 = () => {
    ...
    return (
        <div className="flex items-center min-h-screen w-full"
            style={{ background: "url(https://i.postimg.cc/m2B0GwDw/404.png)", backgroundSize: "cover" }}>
            <div className="w-11/12 mx-auto">
                <div className="boxShadow px-10 py-16 flex flex-col justify-center items-start rounded-xl w-full lg:w-[50%] h-auto">
                    ...
                    <button onClick={() => navigate("/")} className="py-3 px-8 font-bold w-max rounded-full bg-[#9b9998] hover:bg-[#c8554d] text-white mt-5">
                        BACK TO HOME
                    </button>
                </div>
            </div>
