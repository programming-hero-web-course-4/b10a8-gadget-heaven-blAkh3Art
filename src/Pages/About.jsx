...
const About = () => {
    ...
    >
        <img
            src="https://i.postimg.cc/25wvbCYM/profile.jpg"
            alt="profile"
        ...
        <div
            ...
            <div className="flex items-center justify-between border-b border-gray-200 pb-[7px]">
                ...
                <div className="flex items-center gap-[8px]">
                    <a target="_blank" href="https://www.facebook.com/sajeed.ss">
                    ...
                    <a target="_blank" href="https://github.com/blAkh3Art">
                    ...
                    <a target="_blank" href="https://m.me/sajeed.ss">
            ...
            <div className="flex items-center justify-center flex-col mt-5">
                ...
                <h4 className="text-[1.1rem] font-[600] text-gray-700 mt-2">Saklayen Sajeed</h4>
    ...
    <div className="w-10/12">
        <h3 className="text-xl font-bold max-sm:text-center">Saklayen Sajeed</h3>
        <p className="text-lg max-sm:text-center">
            Hi! I am Saklayen Sajeed, a passionate front-end developer and the creator of Gadget Heaven.
